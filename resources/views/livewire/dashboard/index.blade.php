        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                ...
                <h3 class="card-title align-items-start flex-column text-white pt-15">
                    <span class="fw-bold fs-2x mb-3">Data Pokok</span>

                    <div class="fs-4 text-white">
                        <span class="opacity-75">Berikut</span>

                        <span class="position-relative d-inline-block">
                            <a href="/metronic8/demo63/pages/user-profile/projects.html"
                                class="link-white opacity-75-hover fw-bold d-block mb-1">4</a>
                            <!--begin::Separator-->
                            <span
                        ...
                        <span class="opacity-75">Data Pokok</span>
                    </div>
                </h3>
                <!--end::Title-->
            </div>
                    ...
                    <div class="row g-3 g-lg-6">
                        ...
                        <div class="col-6">
                            ...
                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                ...
                                <div class="m-0">
                                    ...
                                    <!--begin::Desc-->
                                    <span class="text-gray-500 fw-semibold fs-6">Komoditas</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Stats-->
                            </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                ...
                                <div class="m-0">
                                    ...
                                    <!--begin::Desc-->
                                    <span class="text-gray-500 fw-semibold fs-6">Pasar</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Stats-->
                            </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                ...
                                <div class="m-0">
                                    <!--begin::Number-->
                                    <span class="text-black fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{ $stok }}</span>
                                    <!--end::Number-->
                        ...
                        <div class="col-6">
                            ...
                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                ...
                                <div class="m-0">
                                    ...
                                    <!--begin::Desc-->
                                    <span class="text-gray-500 fw-semibold fs-6">Distributor</span>
                                    <!--end::Desc-->
                                </div>
                                <!--end::Stats-->
                            </div>
            ...
            <div class="card-body d-flex ps-xl-15">
                ...
                <div class="m-0">
                        ...
                        <span class="me-2">
                            ...
                            <span class="position-relative d-inline-block text-danger">
                                <a href="/metronic8/demo63/pages/user-profile/overview.html"
                                    class="text-danger opacity-75-hover">Admin</a>
                    ...
                    {{-- <div class="mb-3">
                        ...
                        <a href="/metronic8/demo63/apps/support-center/overview.html"
                ...
                <!--begin::Illustration-->
                <img src="/metronic8/demo63/assets/media/illustrations/sigma-1/17-dark.png"
                ...
                <div id="kt_sliders_widget_1_slider"
                    ...
                    <div class="card-header pt-5">
                        ...
                        <h4 class="card-title d-flex align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-800">Kenaikan Tertinggi</span>
                            <span class="text-gray-500 mt-1 fw-bold fs-7">Persentase rata-rata 3 komoditas</span>
                        </h4>
                        <!--end::Title-->
            ...
            <div class="col-xl-6 mb-5 mb-xl-10">
                ...
                <div id="kt_sliders_widget_2_slider"
                    ...
                    <div class="card-header pt-5">
                        <!--begin::Title-->
                        <h4 class="card-title d-flex align-items-start flex-column">
                            <span class="card-label fw-bold text-gray-800">Penurunan Tertinggi</span>
                            <span class="text-gray-500 mt-1 fw-bold fs-7">Persentase rata-rata 3 komoditas</span>
                        </h4>
                        <!--end::Title-->
