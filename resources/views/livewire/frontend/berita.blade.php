                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="h-100 d-flex flex-column justify-content-between pe-lg-6 mb-lg-0 mb-10">
                                            ...
                                            <div class="mb-5">
                                                <!--begin::Title-->
                                                <a href="#" class="fs-2 text-gray-900 fw-bold text-hover-primary text-gray-900 lh-base">
                                                    {{$first_berita->judul}}
                                                </a>
                                                <!--end::Title-->
                                                ...
                                                <div class="fw-semibold fs-5 text-gray-600 text-gray-900 mt-4">
                                                    {!!strlen($first_berita->konten) > 300 ? substr($first_berita->konten, 0, 300) . '...' : $first_berita->konten;!!}
                                                </div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Body-->
                                            ...
                                            <div class="d-flex flex-stack flex-wrap">
                                                ...
                                                <div class="d-flex align-items-center pe-2">
                                                    ...
                                                    <div class="fs-5 fw-bold">
                                                        <a href="/metronic8/demo30/pages/user-profile/overview.html"
                                                            class="text-gray-700 text-hover-primary">{{$first_berita->toUser->nama}}</a>

                                                        <span class="text-muted">on {{tglIndo($first_berita->created_at)}}</span>
                                                    </div>
                                                    <!--end::Text-->
                                                </div>
                                                <!--end::Item-->
                                                ...
                                                @if($first_berita->kategori == 1)
                                                    <span class="badge badge-light-primary fw-bold my-2">{{$first_berita->toKategori->nama}}</span>
                                                @elseif($first_berita->kategori == 2)
                                                    <span class="badge badge-light-success fw-bold my-2">{{$first_berita->toKategori->nama}}</span>
                                                @elseif($first_berita->kategori == 3)
                                                    <span class="badge badge-light-warning fw-bold my-2">{{$first_berita->toKategori->nama}}</span>
                                                @elseif($first_berita->kategori == 4)
                                                    <span class="badge badge-light-danger fw-bold my-2">{{$first_berita->toKategori->nama}}</span>
                                                @endif
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Footer-->
                                        ...
                                        <div class="ps-lg-6 mb-16 mt-md-0 mt-17">
                                            ...
                                            <div class="mb-6">
                                                ...
                                                <a href="#" class="fw-bold text-gray-900 mb-4 fs-2 lh-base text-hover-primary">
                                                    Bootstrap Admin Theme - How To Get Started Tutorial. Create customizable applications
                                                </a>
                                                <!--end::Title-->
                                            ...
                                            <div class="d-flex flex-stack flex-wrap">
                                                ...
                                                <div class="d-flex align-items-center pe-2">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle me-3">
                                                        <img src="/metronic8/demo30/assets/media/avatars/300-20.jpg" class="" alt="">
                                                    </div>
                                                    <!--end::Avatar-->
                                        ...
                                        <div class="ps-lg-6 mb-16">
                                            ...
                                            <div class="d-flex flex-stack flex-wrap">
                                                ...
                                                <div class="d-flex align-items-center pe-2">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px symbol-circle me-3">
                                                        <img src="/metronic8/demo30/assets/media/avatars/300-9.jpg" class="" alt="">
                                                    </div>
                                                    <!--end::Avatar-->
                                        ...
                                        <div class="ps-lg-6 ">
                                            ...
                                            <div class="d-flex flex-stack flex-wrap">
                                                ...
                                                <div class="d-flex align-items-center pe-2">
                                                    <!--begin::Avatar-->
                                                    <div class="symbol symbol-35px symbol-circle me-3">
                                                        <img src="/metronic8/demo30/assets/media/avatars/300-19.jpg" class="" alt="">
                                                    </div>
                                                    <!--end::Avatar-->
