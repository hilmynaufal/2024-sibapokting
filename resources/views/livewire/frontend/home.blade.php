                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <img src="{{Storage::disk('public')->url($listBannerData->gambar)}}"
                                                    class="position-absolute me-3 bottom-2 mt-8 end-0 h-400px w-auto"
                                                    alt="">
                                                <!--end::Illustration-->
                                            </div>
                                            <!--end::Wrapper-->
                                    ...
                                    <div class="card-toolbar">
                                        <div class="mb-0" style="margin-right:4px;">
                                            ...
                                            <div class="w-200 mw-350px">
                                                <input class="form-control form-control-lg" wire:model.live="date"
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <div class="w-200 mw-350px" wire:ignore>
                                                ...
                                                })" wire:model.live="search" name="search" id="search"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="d-flex flex-stack mb-3">
                                                                                        ...
                                                                                        <div class="me-3">
                                                                                            ...
                                                                                            <!--begin::Title-->
                                                                                            <a
                                                                                                class="text-gray-800 text-hover-primary fw-bold">{{limitasiKarakter($item->namakomoditas, 25)}}</a>
                                                                                            <!--end::Title-->
                                                                                        </div>
                                                                                        <!--end::Wrapper-->
                                                                                    ...
                                                                                    <div class="d-flex flex-stack">
                                                                                        ...
                                                                                        <span class="text-gray-500 fw-bold">
                                                                                            ...
                                                                                            <div class="text-gray-800 text-hover-primary fw-bold">
                                                                                                {{rupiah(avgHarga($item->id, $search, $date), 0)}}
                                                                                            </div>
                                                                                            Sebelumnya:
                                                                                            <div class="text-gray-800 text-hover-primary fw-bold">
                                                                                                {{rupiah(avgHarga($item->id, $search, $date_before), 0)}}
                                                                                            </div>
                                                                                        </span>
                                                                                        <!--end::Name-->
                                ...
                                <div class="card-header pt-7">
                                    ...
                                    <div class="card-toolbar">
                                        <div class="mb-0">
                                            <label class="form-label">Pilih Pasar</label>
                                            <div class="w-200 mw-350px" wire:ignore>
                                                <select x-init="$($el).select2();" wire:model="searchPasar"
                                                    name="searchPasar" id="searchPasar"
                                                    class="form-control form-control-lg form-select-solid">
                                                    <option value="">Semua Pasar</option>
                                                    @foreach($list_pasar as $pasar)
                                                        <option value="{{$pasar->id}}">{{$pasar->namapasar}}</option>
