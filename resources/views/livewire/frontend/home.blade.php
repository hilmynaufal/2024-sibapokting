                ...
                <div class="row g-5 g-xl-10">
                    ...
                    <div class="col-xl-4 mb-xl-10">
                        ...
                        <div id="kt_sliders_widget_7_slider"
                            ...
                            data-bs-ride="carousel" data-bs-interval="5000" style="background-color: #FFE896"
                            data-bs-theme="light">
                            <!--begin::Header-->
                            <div class="card-header align-items-center pt-7">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <ol
                                        class="p-0 m-0 carousel-indicators carousel-indicators-bullet carousel-indicators-active-dark">
                                        <li data-bs-target="#kt_sliders_widget_7_slider" data-bs-slide-to="0"
                                            class="active ms-1"></li>
                                        <li data-bs-target="#kt_sliders_widget_7_slider" data-bs-slide-to="1"
                                            class=" ms-1"></li>
                                        <li data-bs-target="#kt_sliders_widget_7_slider" data-bs-slide-to="2"
                                            class=" ms-1"></li>
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active show">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="w-80px flex-shrink-0 me-2">
                                                <div class="min-h-auto ms-n3" id="kt_slider_widget_7_chart_1"
                                                    style="height: 100px">
                                                </div>
                                            </div>
                                            <!--end::Chart-->
                                            ...
                                            <div class="m-0">
                                                <!--begin::Subtitle-->
                                                <h5 class="fw-bold text-gray-800 mb-3">Ruby on Rails
                                                </h5>
                                                <!--end::Subtitle-->
                                                ...
                                                <div class="d-flex d-grid gap-5">
                                                    ...
                                                    <div class="d-flex flex-column flex-shrink-0 me-4">
                                                        <!--begin::Section-->
                                                        <span
                                                            class="d-flex align-items-center fs-7 fw-bold text-gray-600 mb-2">
                                                            <i
                                                        ...
                                                        <!--begin::Section-->
                                                        <span
                                                            class="d-flex align-items-center text-gray-600 fw-bold fs-7">
                                                            <i
                                                                class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i>
                                                            1 agenda
                                                        </span>
                                    ...
                                    <div class="carousel-item ">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!--begin::Chart-->
                                            <div class="w-80px flex-shrink-0 me-2">
                                                <div class="min-h-auto ms-n3" id="kt_slider_widget_7_chart_2"
                                                    style="height: 100px">
                                                </div>
                                            </div>
                                            <!--end::Chart-->
                                    ...
                                    <div class="carousel-item ">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <!--begin::Chart-->
                                            <div class="w-80px flex-shrink-0 me-2">
                                                <div class="min-h-auto ms-n3" id="kt_slider_widget_7_chart_3"
                                                    style="height: 100px">
                                                </div>
                                            </div>
                                            <!--end::Chart-->
                            ...
                            <div class="card-body d-flex justify-content-center flex-wrap ps-xl-15 pe-0">
                                ...
                                <div class="flex-grow-1 mt-2 me-9 me-md-0">
                                    ...
                                    <span class="text-gray-600 fw-semibold fs-6 mb-6 d-block">
                                        Flat illustrations and swesome with our multi color
                                        <br />
                                        vivid unblended purple hair lady
                                    </span>
                                    <!--end::Text-->
                                    ...
                                    <div class="mb-7">
                                        <a href='https://devs.keenthemes.com/'
                                            class="btn btn-sm btn-primary fw-semibold me-2" data-bs-toggle="modal"
                                ...
                                <!--begin::Illustration-->
                                <img src="https://preview.keenthemes.com/metronic8/demo23/assets/media/illustrations/misc/credit-card.png"
                                    class="h-175px me-15" alt="" />
                                <!--end::Illustration-->
                            </div>
                            <!--end::Body-->
                        </div>
                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Delivery
                                        Tracking</span>
                                            ...
                                            <div class="timeline timeline-border-dashed">
                                                ...
                                                <div class="timeline-item pb-5">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-500">6391
                                                            Elgin St. Celina, Delaware 10299</span>
                                                        <!--end::Title-->
                                                    </div>
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-500">2464
                                                            Royal Ln. Mesa, New Jersey 45463</span>
                                                        <!--end::Title-->
                                                    </div>
                                                    <!--end::Timeline content-->
                                                </div>
                                            ...
                                            <div class="timeline timeline-border-dashed">
                                                ...
                                                <div class="timeline-item pb-5">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-500">3891
                                                            Ranchview Dr. Richardson, California
                                                            62639</span>
                                                        <!--end::Title-->
                                                    </div>
                                                    <!--end::Timeline content-->
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-500">8502
                                                            Preston Rd. Inglewood, Maine 98380</span>
                                                        <!--end::Title-->
                                                    </div>
                                                    <!--end::Timeline content-->
                                                </div>
                                            ...
                                            <div class="timeline timeline-border-dashed">
                                                ...
                                                <div class="timeline-item pb-5">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-500">3517 W.
                                                            Gray St. Utica, Pennsylvania 57867</span>
                                                        <!--end::Title-->
                                                    </div>
                                                    <!--end::Timeline content-->
                                                </div>
                                                ...
                                                <div class="timeline-item">
                                                    ...
                                                    <div class="timeline-content m-0">
                                                        ...
                                                        <!--begin::Title-->
                                                        <span class="fw-semibold text-gray-500">Total
                    ...
                    <div class="col-xl-8 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    <a href="https://preview.keenthemes.com/metronic8/demo23/apps/ecommerce/catalog/add-product.html"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-40px me-3">
                                                                    <img src="https://preview.keenthemes.com/metronic8/demo23/assets/media/avatars/300-12.jpg"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-40px me-3">
                                                                    <img src="https://preview.keenthemes.com/metronic8/demo23/assets/media/avatars/300-11.jpg"
                                                                        class="" alt="" />
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="symbol symbol-40px me-3">
                                                                    <img src="https://preview.keenthemes.com/metronic8/demo23/assets/media/avatars/300-13.jpg"
                                                                        class="" alt="" />
                                                                </div>
