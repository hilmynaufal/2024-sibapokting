            ...
            <div id="kt_app_content_container" class="app-container container-xxl ">
                ...
                <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                        ...
                        <!--begin::Recent posts-->
                        <div class="m-0">
                            <h4 class="text-gray-900 mb-7">Berita Lainnya</h4>
                            @foreach($list_berita as $list)
                            <!--begin::Item-->
                            <div class="d-flex flex-stack mb-7">
                                ...
                                <!--begin::Title-->
                                <div class="m-0">
                                    <a href="{{route('beritadetail',[Crypt::encrypt($list->id)])}}" class="text-gray-900 fw-bold text-hover-primary fs-6">{{strlen($list->judul) > 20 ? substr($list->judul, 0, 20)
                                                        . '...' : $list->judul}}</a>
