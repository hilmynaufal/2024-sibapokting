                        ...
                        <div class="mb-17">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="overlay mt-8">
                                    ...
                                    <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px"
                                        style="background-image:url('/metronic8/demo30/assets/media/stock/1600x800/img-1.jpg')">
                                    </div>
                                    <!--end::Image-->

                                    <!--begin::Links-->
                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        <a href="/metronic8/demo30/pages/about.html" class="btn btn-primary">About Us</a>
                                        <a href="/metronic8/demo30/pages/careers/apply.html" class="btn btn-light-primary ms-3">Join
                                            Us</a>
                                    </div>
                                    <!--end::Links-->
                                </div>
                            ...
                            <div class="fs-5 fw-semibold text-gray-600">
                                ...
                                <p class="mb-8">
                                    ...
                                    of hours, even if you can type eighty words per minute and your writing skills are sharp.
                                    From the seed of the idea to finally hitting “Publish,” you might spend several days or maybe
                                    even a week “writing” a blog post, but it’s important to spend those vital hours planning
                                    your post and even thinking about

                                    <a href="/metronic8/demo30/pages/blog/post.html" class="link-primary pe-1">Your Post</a>
                                ...
                                <p class="mb-8">
                                    ...
                                    No matter what industry you’re working in, as a blogger, you should live and die by this
                                    statement.
                                </p>
                                <!--end::Text-->
                                ...
                                <p class="mb-8">
                                    ...
                                    <a href="/metronic8/demo30/pages/blog/home.html" class="link-primary pe-1">I mean NOTHING</a>
                                ...
                                <p class="mb-17">
                                    ...
                                    Blogging is a lot easier, however, if you can muster at least a little enthusiasm for the topic
                                    at hand.
                                </p>
                                <!--end::Text-->
                            </div>
                            ...
                            <div class="d-flex align-items-center border-1 border-dashed card-rounded p-5 p-lg-10 mb-14">
                                ...
                                <div class="text-center flex-shrink-0 me-7 me-lg-13">
                                    ...
                                    <div class="symbol symbol-70px symbol-circle mb-2">
                                        <img src="/metronic8/demo30/assets/media/avatars/300-2.jpg" class="" alt="">
                                    </div>
                                    <!--end::Avatar-->
                                ...
                                <div class="mb-0 fs-6">
                                    <div class="text-muted fw-semibold lh-lg mb-2">
                                        ...
                                        couple of hours, even if you can type
                                        eighty words per minute and your writing skills are sharp writing a blog post often takes
                                        more than a couple.
                                    </div>
                            ...
                            <div class="d-flex flex-center">
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="/metronic8/demo30/assets/media/svg/brand-logos/facebook-4.svg" class="h-20px my-2"
                                        alt="">
                                </a>
                                <!--end::Icon-->
                                ...
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="/metronic8/demo30/assets/media/svg/brand-logos/instagram-2-1.svg" class="h-20px my-2"
                                        alt="">
                                </a>
                                <!--end::Icon-->
                                ...
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="/metronic8/demo30/assets/media/svg/brand-logos/github.svg" class="h-20px my-2" alt="">
                                </a>
                                <!--end::Icon-->

                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="/metronic8/demo30/assets/media/svg/brand-logos/behance.svg" class="h-20px my-2"
                                        alt="">
                                </a>
                                <!--end::Icon-->
                                ...
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="/metronic8/demo30/assets/media/svg/brand-logos/pinterest-p.svg" class="h-20px my-2"
                                        alt="">
                                </a>
                                <!--end::Icon-->
                                ...
                                <!--begin::Icon-->
                                <a href="#" class="mx-4">
                                    <img src="/metronic8/demo30/assets/media/svg/brand-logos/twitter.svg" class="h-20px my-2"
                                        alt="">
                                </a>
                                <!--end::Icon-->
                    ...
                    <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex flex-stack mb-7">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="background-image: url('/metronic8/demo30/assets/media/stock/600x400/img-1.jpg')">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                                ...
                                <div class="m-0">
                                    ...
                                    <span class="text-gray-600 fw-semibold d-block pt-1 fs-7">We’ve been a focused on making a the
                                        sky</span>
                                </div>
                                <!--end::Title-->
                            </div>
                            ...
                            <div class="d-flex flex-stack mb-7">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="background-image: url('/metronic8/demo30/assets/media/stock/600x400/img-2.jpg')">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-stack mb-7">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="background-image: url('/metronic8/demo30/assets/media/stock/600x400/img-3.jpg')">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                            ...
                            <div class="d-flex flex-stack ">
                                ...
                                <div class="symbol symbol-60px symbol-2by3 me-4">
                                    <div class="symbol-label"
                                        style="background-image: url('/metronic8/demo30/assets/media/stock/600x400/img-4.jpg')">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                    ...
                    <div class="row g-10">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch me-md-6">
                                ...
                                <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                    style="background-image:url('/metronic8/demo30/assets/media/stock/600x400/img-73.jpg')"
                                    data-fslightbox="lightbox-video-tutorials" href="https://www.youtube.com/embed/btornGtLwIo">

                                    <img src="/metronic8/demo30/assets/media/svg/misc/video-play.svg"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch mx-md-3">
                                <!--begin::Image-->
                                <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                    style="background-image:url('/metronic8/demo30/assets/media/stock/600x400/img-74.jpg')"
                                    data-fslightbox="lightbox-video-tutorials" href="https://www.youtube.com/embed/btornGtLwIo">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch ms-md-6">
                                <!--begin::Image-->
                                <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                    style="background-image:url('/metronic8/demo30/assets/media/stock/600x400/img-47.jpg')"
                    ...
                    <div class="row g-10">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch me-md-6">
                                ...
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    href="/metronic8/demo30/assets/media/stock/600x400/img-23.jpg">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image:url('/metronic8/demo30/assets/media/stock/600x400/img-23.jpg')">
                                    </div>
                                    <!--end::Image-->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch mx-md-3">
                                <!--begin::Overlay-->
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    href="/metronic8/demo30/assets/media/stock/600x600/img-14.jpg">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image:url('/metronic8/demo30/assets/media/stock/600x600/img-14.jpg')">
                                    </div>
                                    <!--end::Image-->
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card-xl-stretch ms-md-6">
                                <!--begin::Overlay-->
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    href="/metronic8/demo30/assets/media/stock/600x400/img-71.jpg">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="background-image:url('/metronic8/demo30/assets/media/stock/600x400/img-71.jpg')">
                                    </div>
                                    <!--end::Image-->
