                            ...
                            <div class="card-body py-3">
                                <div class="row col-md-12 mb-5">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <div wire:ignore>
                                            <select x-init="$($el).select2();
                                                ...
                                                })" wire:model.live="pasar_tabel"
                                                name="pasar_tabel" id="pasar_tabel"
                                                class="form-control form-control-sm form-select-solid">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="w-200 mw-350px position-relative">
                                            <!--begin::Input-->
                                            <input class="form-control form-control-sm" wire:model.live="date_start"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="w-200 mw-350px position-relative">
                                            <!--begin::Input-->
                                            <input class="form-control form-control-sm" wire:model.live="date_end"
