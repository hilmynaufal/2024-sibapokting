                    ...
                    <div class="d-flex flex-wrap d-grid gap-5 px-9 mb-5">
                        <div class="me-md-2">
                            <div class="d-flex mb-2">
                                ...
                                <span
                                    class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{{nilai(getKomoditas($komoditas)->het,0)}}</span>
                            </div>
                        ...
                        <div class="m-0">
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <span
                                    class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{{nilai(avgHarga($komoditas,0,$date_komoditas_before),0)}}</span>
                            </div>
                            <span class="fs-6 fw-semibold text-gray-500">Rata"
                                {{tglIndo($date_komoditas_before)}}</span>
                        </div>
                        <div
                            ...
                            <div class="d-flex mb-2">
                                <span class="fs-4 fw-semibold text-gray-500 me-1">Rp</span>
                                <span
                                    class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2">{{nilai(avgHarga($komoditas,0,$date_komoditas),0)}}</span>
                                {!!
