                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                        ...
                        <thead>
                            <tr class="text-uppercase">
                                <th class="pl-0" style="min-width: 100px">Kode Hak Tanah 
                                </th>
                                <th class="pl-0" style="min-width: 100px">Nama Hak Tanah
                                    @if ($sortColoumName === 'kd_hak_tanah')
                                    <span wire:click="sortBy('kd_hak_tanah')" class="float-end text-sm"
                                        style="cursor: pointer;">
                                        <i
                                            class="{{ $sortColoumName === 'kd_hak_tanah' && $sortDirection === 'desc' ? ' fas fa-sort-up ' : 'fas fa-sort-down' }}"></i>
                                    </span>
                                    @else
                                    <span wire:click="sortBy('kd_hak_tanah')" class="float-end text-sm"
                                        style="cursor: pointer;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->kd_hak_tanah}}</span>
                                </td>
                                <td>
                                    <span class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->nm_hak_tanah}}</span>
                                </td>
                                <td>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-3 fv-row fv-plugins-icon-container">
                            <label class="required form-label">Kode Hak Tanah</label>
                            <input type="hidden" class="form-control  @error('id_hak_tanah') is-invalid @enderror" wire:model="id_hak_tanah" />
                            <input type="text" class="form-control  @error('kd_hak_tanah') is-invalid @enderror" wire:model="kd_hak_tanah" />
                            @error('kd_hak_tanah')
                        ...
                        <div class="mb-3 fv-row fv-plugins-icon-container">
                            <label class="required form-label">Nama Hak Tanah</label>
                            <input type="text" class="form-control  @error('nm_hak_tanah') is-invalid @enderror" wire:model="nm_hak_tanah" />
                            @error('nm_hak_tanah')
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                {{ $message }} </div>
                            @enderror
