...
@stop
@section('menu')
Referensi > Pajak > <b>Dokumen Tanah</b>
@stop
<!--begin::Col-->
                    ...
                    <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                        ...
                        <thead>
                            <tr class="text-uppercase">
                                <th class="pl-0" style="min-width: 400px">Nama Dokumen Tanah
                                    @if ($sortColoumName === 'nm_dok_tanah')
                                    <span wire:click="sortBy('nm_dok_tanah')" class="float-end text-sm"
                                        style="cursor: pointer;">
                                        <i
                                            class="{{ $sortColoumName === 'nm_dok_tanah' && $sortDirection === 'desc' ? ' fas fa-sort-up ' : 'fas fa-sort-down' }}"></i>
                                    </span>
                                    @else
                                    <span wire:click="sortBy('nm_dok_tanah')" class="float-end text-sm"
                                        style="cursor: pointer;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->nm_dok_tanah}}</span>
                                </td>
                                <td>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-3 fv-row fv-plugins-icon-container">
                            <label class="required form-label">Nama Dokumen Tanah</label>
                            <input type="hidden" class="form-control  @error('id_dok_tanah') is-invalid @enderror" wire:model="id_dok_tanah" />
                            <input type="text" class="form-control  @error('nm_dok_tanah') is-invalid @enderror" wire:model="nm_dok_tanah" />
                            @error('nm_dok_tanah')
