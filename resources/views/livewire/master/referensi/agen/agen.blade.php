            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Data Master Agen</span>
                    </h3>
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->namaagen }}<br>Telp : {{ $item->notelp }}</span>
                                    </td>
                                    <td>
                                        <span
                                    ...
                                    <td style="width: 200px;" class="text-center">
                                        <div class="btn-list">
                                            <a href="{{route('master.referensi.mapsagen',[Crypt::encrypt($item->id)])}}"
                                                class="btn btn-sm btn-icon btn-light-primary btn-active-light-default me-1"
                                                title="Ubah">
                                                <i class="bi bi-map"></i>
                                            </a>
                                            <a href="{{route('master.referensi.editagen',[Crypt::encrypt($item->id)])}}"
