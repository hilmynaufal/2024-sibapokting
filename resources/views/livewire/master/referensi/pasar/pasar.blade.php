            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold fs-3 mb-1">Data Master Pasar</span>
                    </h3>
                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                        data-bs-original-title="Click to add a user" data-kt-initialized="1">
                        <a href="{{route('master.referensi.addpasar')}}" class="btn btn-sm btn-light btn-active-primary">
                            <i class="ki-duotone ki-plus fs-2"></i> Tambah Pasar
                        </a>
                    </div>
                </div>
                <!--end::Header-->
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->namapasar}}</span>
                                    </td>
                                    <td>
                                        <span
