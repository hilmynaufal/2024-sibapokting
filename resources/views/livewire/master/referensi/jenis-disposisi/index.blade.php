<div>
    @section('title', 'Master Instruksi Disposisi')
            ...
            <table class="table table-head-custom table-vertical-center table-hover table-striped" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th style="min-width: 120px text-center">Instruksi Disposisi
    ...
    <form action="">
        <div>
            <div class="form-group">
                ...
                <input type="text" class="form-control  @error('kode') is-invalid @enderror" placeholder="Ex: JB" wire:model="kode" />
                <input type="hidden" class="form-control  @error('nama_id') is-invalid @enderror" wire:model="nama_id" />
                @error('kode')
            ...
            <div class="form-group">
                ...
                <span class="text-danger">*</span></label>
                <input type="text" class="form-control  @error('nama') is-invalid @enderror" placeholder="Ex: Jamkrida Jawa Barat" wire:model="nama" />
                @error('nama')
                    <div class="invalid-feedback form-text text-danger"> {{ $message }} </div>
                @enderror
            </div>                                                
