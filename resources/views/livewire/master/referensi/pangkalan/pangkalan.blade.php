                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->namapangkalan }}<br>Telp : {{ $item->notelp }}</span>
                                    </td>
                                    <td>
                                        <span
                                            class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ empty($item->toAgen->namaagen) ? '-' : $item->toAgen->namaagen}}
                                            <br>Telp : {{ empty($item->toAgen->namaagen) ? '-' : $item->toAgen->notelp }}</span>
                                    </td>
                                    <td>
                                        <span
                                    ...
                                    <td>
                                        <span
                                            class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->keterangan}}</span>
                                    </td>
                                    <td style="width: 200px;" class="text-center">
                                        <div class="btn-list">
                                            <a href="{{route('master.referensi.mapspangkalan',[Crypt::encrypt($item->id)])}}"
                                                class="btn btn-sm btn-icon btn-light-primary btn-active-light-default me-1"
                                                title="Ubah">
                                                <i class="bi bi-map"></i>
                                            </a>
                                            <a href="{{route('master.referensi.editpangkalan',[Crypt::encrypt($item->id)])}}"
