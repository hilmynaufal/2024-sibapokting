                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-3 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control  @error('username') is-invalid @enderror" placeholder="Ex: admin" wire:model="username" />
                                    ...
                                    <div class="mb-3 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control  @error('nama') is-invalid @enderror" placeholder="Ex: Super Admin" wire:model="nama" />
                                        @error('nama')
                                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }} </div>
                                        @enderror
                                    </div>
                                    <div class="mb-3 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control  @error('email') is-invalid @enderror" placeholder="Ex: admin@gmail.com" wire:model="email" />
                                        @error('email')
                                        <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">{{ $message }} </div>
                                        @enderror
                                    </div>
                                    <div class="mb-3 fv-row fv-plugins-icon-container" wire:ignore>
                                        ...
                                        name="role_id" id="role_id"  class="form-control form-control-lg ">
