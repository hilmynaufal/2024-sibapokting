                ...
                <form class="form-horizontal" wire:submit="create">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="py-5" data-bs-theme="light">
                                    <textarea name="deskripsi" id="deskripsi" wire:model="deskripsi" rows="10" cols="100"></textarea>
                                    @error('deskripsi') <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group mb-3 fv-row fv-plugins-icon-container">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="py-5" data-bs-theme="light">   
                                    <x-filepond title="Gambar Banner" 
                                    required="required" 
                    ...
                    <div class="card-footer">
                        <a class="btn btn-secondary" href="{{route('website.banner.index')}}">Close</a>
