                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $item->toPasar->namapasar }}</td>
                                    <td>{{ $item->toKomoditas->namakomoditas }}</td>
                                    <td>
                                        <span
                                            class="text-center text-gray-80 font-weight-bolder text-hover-success font-size-lg">{{ $item->kode}}</span>
                                    </td>
                                    <td>
                                        <span
