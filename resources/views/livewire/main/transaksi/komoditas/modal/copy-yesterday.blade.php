...
<div class="modal fade show" id="copyYesterdayModal" data-bs-focus="false" style="display: block; padding-left: 0px;"
    aria-modal="true" role="dialog">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Salin Data Komoditas dari Kemarin</h5>
            ...
            <div class="modal-body" style="text-align:left;">
                    ...
                    <form wire:submit="loadPreview">
                        ...
                        <div class="alert alert-info d-flex align-items-center mb-5">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span>Fitur ini akan menyalin data komoditas dari kemarin ke tanggal yang dipilih. Data yang sudah ada akan dilewati (skip).</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3 fv-row fv-plugins-icon-container">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control form-control-solid" value="{{$pasar_nama}}" readonly />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3 fv-row fv-plugins-icon-container">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label fw-bold">Tanggal Asal (Sumber Data)</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control form-control-solid" value="{{tglIndo($tanggal_asal)}}" readonly />
                        ...
                        <div class="form-group mb-3 fv-row fv-plugins-icon-container">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label fw-bold">Tanggal Tujuan <span class="text-danger">*</span></label>
                                </div>
                                <div class="col-md-9">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary" wire:loading.attr="disabled" wire:target="loadPreview">
                ...
                @else
                    ...
                    @if($totalWillCopy > 0)
                        <div class="alert alert-success d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span>Data ini akan disalin dari {{tglIndo($tanggal_asal)}} ke {{tglIndo($tanggal_tujuan)}}</span>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($totalSkipped > 0)
                        <div class="alert alert-warning d-flex align-items-center mb-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span>Data komoditas ini sudah tersedia di tanggal tujuan</span>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-success" wire:click="copyData"
                            wire:loading.attr="disabled" wire:target="copyData"
                            @if($totalWillCopy == 0) disabled @endif>
