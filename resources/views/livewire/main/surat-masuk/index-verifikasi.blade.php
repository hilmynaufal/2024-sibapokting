...
<div class="mailbox-detail col-sm-6">
          ...
          <div class="form-action m-t-24">
            <div class="row">
              ...
              <div class="col-sm-6">
                ...
                @livewire('main.surat-masuk.form-verifikasi',['id'=>$surat_masuk_id])
  ...
  @livewire('main.surat-masuk.form-disposisi',['id'=>$primaryId])

  @livewire('main.surat-masuk.timeline-modal',['id'=>$primaryId])
