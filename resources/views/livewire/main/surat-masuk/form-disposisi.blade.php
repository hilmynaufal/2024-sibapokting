<div>
  <div wire:ignore.self class="modal fade" id="modal-kirim-disposisi" tabindex="-1" aria-labelledby="modal-kirim-disposisiLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9"  wire:ignore>
              ...
              <select required="true" data-pharaonic="select2" data-clear="true" id="disposisi_tujuan" name="disposisi_tujuan" wire:model="disposisi_tujuan" class="form-select select2 select2-multiple @error('disposisi_tujuan') is-invalid @enderror" multiple="multiple" data-placeholder="-- Pilih Tujuan Disposisi --">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9" wire:ignore>
              <select required="true" data-pharaonic="select2" data-clear="true" id="disposisi_instruksi" name="disposisi_instruksi" class="form-select select2 select2-multiple @error('disposisi_instruksi') is-invalid @enderror" multiple="multiple" data-placeholder="-- Pilih Instruksi Disposisi --">
