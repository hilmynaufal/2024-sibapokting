    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{$this->title}} Perhitungan Office Assesment</h5>
                ...
                <form wire:submit="create">
                    <div class="form-group mb-3 mt-3 fv-row fv-plugins-icon-container">
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <input type="text" class="form-control input_nop" disabled wire:model.live="kd_propinsi" id="kd_propinsi" name="kd_propinsi" maxlength="2" value="32" readonly="readonly">
                            </div>
                            <div class="col-md-1">
                                <input type="text" class="form-control input_nop" disabled wire:model.live="kd_dati2" id="kd_dati2" name="kd_dati2" maxlength="2" value="06" readonly="readonly">
                            </div>
                            <div class="col-md-1">
                                <input type="text" class="form-control input_nop" disabled wire:model.live="kd_kecamatan" id="kd_kecamatan" name="kd_kecamatan" maxlength="3" value="">
                            </div>
                            <div class="col-md-1">
                                <input type="text" class="form-control input_nop" disabled wire:model.live="kd_kelurahan" id="kd_kelurahan" name="kd_kelurahan" maxlength="3" value="">
                            </div>
                            <div class="col-md-1">
                                <input type="text" class="form-control input_nop" disabled wire:model.live="kd_blok" id="kd_blok" name="kd_blok" maxlength="3" value="">
                            </div>
                            <div class="col-md-1">
                                <input type="text" class="form-control input_nop" disabled wire:model.live="no_urut" id="no_urut" name="no_urut" maxlength="4" value="">
                            </div>
                            <div class="col-md-1">
                                <input type="text" class="form-control input_nop" disabled wire:model.live="kd_jns_op" id="kd_jns_op" name="kd_jns_op" maxlength="1" value="">
                            </div>
                            <div class="col-md-5">
                    ...
                    <div class="footer">
                        ...
                        <div class="btn-list">
                            <button type="submit" class="btn btn-info float-end" wire:target="create" wire:loading.class.remove="bg-info" id="next">
                                Simpan Perhitungan Verifikasi <i class="fa fa-card"></i>
                            </button>
                        </div>
                    </div>
                </form>
