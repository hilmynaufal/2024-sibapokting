<div>
        ...
        <div class="mb-10">
            ...
            <table class="table fs-6 fw-semibold gs-0 gy-2 gx-2">
                ...
                <tbody><tr class="">
                    ...
                    <td class="text-gray-800">{{ $pembayaran_pajak->kode_bayar }}</td>
                </tr>
                <!--end::Row-->
                ...
                <tr class="">
                    ...
                    <td><span class="badge badge-light-success">{{ $pembayaran_pajak->status_tagihan }}</span></td>
                </tr>
                <!--end::Row-->
                ...
                <tr class="">
                    ...
                    <td class="text-gray-800">Rp. {{number_format($pembayaran_pajak->total_tagihan)}},</td>
                </tr>
                <!--end::Row-->
            </tbody></table>
            <!--end::Details-->
        ...
        <div class="mb-10">
            ...
            <table class="table fs-6 fw-semibold gs-0 gy-2 gx-2">
                ...
                <tr class="">
                    ...
                    <td><span class="badge badge-light-danger">{{ $pembayaran_pajak->status_bayar }}</span></td>
                </tr>
                <!--end::Row-->
        ...
        @if ($pembayaran_pajak->status_tagihan!="Aktif")
          ...
          <form wire:submit="create">
            ...
            <button class="btn btn-warning text-center btn-block" wire:target="create" wire:confirm="Apakah Anda Yakin untuk Membayar Hari Ini ?">
        ...
        @if (Auth::user()->role_id=="1")
          <div class="separator separator-dashed mb-7"></div>
            <center>
                <div class="d-grid gap-2">
            <button class="btn btn-warning text-center btn-block" 
            wire:click="$dispatch('openModal', { component: 'main.layanan.bphtb.modal.perhitungan-verifikasi' , arguments: { id: {{ $pembayaran_pajak->id_bphtb }} }})">
                <span wire:loading class="spinner-border spinner-border-sm align-middle ms-2"></span>
                Verifikasi Office Assesment 
            </button>
                </div>
        </center>
        @endif
