<div>
    @section('title')
    4. Informasi Lokasi Objek Pajak
    @stop
    @section('menu')
    ...
    <fieldset>
        <form wire:submit="create">
            ...
            <div class="form-group mb-3 fv-row fv-plugins-icon-container">
                <div class="row">
                    <div class="col-md-2">
                        <label class="form-label">Daftar Persyaratan</label>
                    </div>
                    <div class="col-md-10">

                        @livewire('main.layanan.bphtb.form.persyaratan-verifikasi',[Crypt::encrypt($this->id_bphtb)])
