...
<head>
    ...
    @include('components.layouts.keenthemes.parsial.css')
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page  flex-column flex-column-fluid " id="kt_app_page">
            ...
            <div id="kt_app_header" class="app-header " data-kt-sticky="true"
                ...
                <div class="app-container  container-fluid d-flex flex-stack " id="kt_app_header_container">
                    ...
                    <div class="d-flex flex-stack flex-lg-row-fluid" id="kt_app_header_wrapper">
                        ...
                        <!--begin::Navbar-->
                        <x-layouts.keenthemes._topbar></x-layouts.keenthemes._topbar>
                        <!--end::Navbar-->
                    </div>
                    <!--end::Header wrapper-->
                </div>
            ...
            <div class="app-wrapper  flex-column flex-row-fluid " id="kt_app_wrapper">
                ...
                <x-layouts.keenthemes._sidebar></x-layouts.keenthemes._sidebar>
                <!--begin::Main-->
                <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <!--begin::Footer-->
                            <x-layouts.keenthemes._footer></x-layouts.keenthemes._footer>
            ...
            @include('components.layouts.keenthemes.parsial.js')
            <script>
