                ...
                <div class="app-container  container-xxl d-flex align-items-stretch justify-content-between "
                    ...
                    <div class="app-header-wrapper d-flex flex-grow-1 align-items-stretch justify-content-between"
                        ...
                        <div class="app-header-logo d-flex flex-shrink-0 align-items-center justify-content-between justify-content-lg-center">
                            ...
                            <!--begin::Logo image-->
                            <a href="/metronic8/demo37/index.html">
                                <img alt="Logo" src="/metronic8/demo37/assets/media/logos/default-small.svg" class="h-30px h-lg-40px theme-light-show">
                                <img alt="Logo" src="/metronic8/demo37/assets/media/logos/default-small-dark.svg" class="h-30px h-lg-40px theme-dark-show">
                            </a>
                            <!--end::Logo image--> 
                        </div>
                        <!--begin::Menu wrapper-->
