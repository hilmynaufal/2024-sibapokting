...
class Detail extends Component
{
    ...
    public function detail($id)
    {
        ...
        $disposisi = Disposisi::where('id','=',$disposisi_masuk->disposisi_id)->first();
    ...
    {
        return view('livewire.main.disposisi-masuk.detail',['primaryId'=>$this->primaryId]);
    }
