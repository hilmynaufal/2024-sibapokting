...
class DetailSurat extends Component
{
    ...
    public function detail($id)
    {
        // dd($id);
        $this->primaryId = $id;
        $disposisi_masuk = DisposisiKeluar::where('disposisi_id','=',$this->primaryId)->first();
    ...
    {
        return view('livewire.main.disposisi-keluar.detail-surat',['primaryId'=>$this->primaryId]);
    }
