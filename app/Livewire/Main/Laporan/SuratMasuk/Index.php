...
namespace App\Livewire\Main\Laporan\SuratMasuk;
...
class Index extends Component
{
    ...
    {        
        ...
        return view('livewire.main.laporan.surat-masuk.index', [ 'model' => $model ]);
    }
    
    public function store()
    {
        return (new SuratMasukExport($this->tgl_awal, $this->tgl_akhir, $this->no_surat, $this->tujuan, $this->status, $this->search))->download('Export Data Surat Masuk.xlsx');
    }
