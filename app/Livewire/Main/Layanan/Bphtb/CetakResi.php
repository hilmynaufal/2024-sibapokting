...
class CetakResi extends Component
{
    ...
    {
        return view('livewire.main.layanan.bphtb.cetak.cetak-resi')->extends('components.layouts.keenthemes.print_no_table');
    }
    ...
    public function mount($id)
    {
        ...
        if ($data) {
            ...
            $this->op_notaris               = $data->notaris->nama;
