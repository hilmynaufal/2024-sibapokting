...
class CetakVerifikasi extends Component
{
    ...
    {
        return view('livewire.main.layanan.bphtb.cetak.cetak-verifikasi')->extends('components.layouts.keenthemes.print_verifikasi');
    }
