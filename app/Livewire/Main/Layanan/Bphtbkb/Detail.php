...
class Detail extends Component
{
    ...
    {
        return view('livewire.main.layanan.bphtbkb.detail');
    }
    ...
    public function create()
    {
        ...
        $objek_pajak_sebelum = ObjekPajak::where('id_bphtb',$this->id_bphtb)->first();
        ...
        $pembayaran = PembayaranPajakKurang::updateOrCreate([
            ...
            'total_tagihan' => $objek_pajak->nilai_bayar_bphtb,
                ...
                'total_tagihan' => $objek_pajak->nilai_bayar_bphtb - $objek_pajak_sebelum->nilai_bayar_bphtb ,
            ...
            return redirect()->route('main.layanan.bphtbkb.index');
        }
