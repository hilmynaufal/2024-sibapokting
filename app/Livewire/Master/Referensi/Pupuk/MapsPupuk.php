...
class MapsPupuk extends Component
{
    use LivewireAlert;
    ...
    {
        return view('livewire.master.referensi.pupuk.maps-pupuk');
    }
    ...
    public function create()
    {
            ...
            if($model->update()){
                $this->alert('success', 'Perubahan Data Kios Pupuk Berhasil di Simpan', [
                    'position' => 'top',
                    'timer' => 3000,
                    'toast' => true,
                ...
                $this->alert('error', 'Perubahan Data Kios Pupuk Gagal di Simpan', [
                    'position' => 'top',
                    'timer' => 3000,
                    'toast' => true,
                    'timerProgressBar' => true,
