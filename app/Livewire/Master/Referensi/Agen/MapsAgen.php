...
class MapsAgen extends Component
{
    use LivewireAlert;
    ...
    {
        return view('livewire.master.referensi.agen.maps-agen');
    }
    ...
    public function create()
    {
            ...
            if($model->update()){
                $this->alert('success', 'Perubahan Data Agen Berhasil di Simpan', [
                    'position' => 'top',
                    'timer' => 3000,
                    'toast' => true,
                ...
                $this->alert('error', 'Perubahan Data Agen Gagal di Simpan', [
                    'position' => 'top',
                    'timer' => 3000,
                    'toast' => true,
                    'timerProgressBar' => true,
