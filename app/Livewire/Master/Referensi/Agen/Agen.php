...
class Agen extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.master.referensi.agen.agen', [
          'model'=> $rows
        ]);
    }
    ...
    //         ]);
    //     }
    //     return redirect()->route('master.referensi.agen.ageng');
    ...
    public function deleteSelectedRequest($id)
    {
        if(Model::where('id',$id)->delete()){
            $log = 'Data Agen Berhasil di Hapus';
            setActivity($log);
            $this->alert('success', $log, [
                'position' => 'top-end',
                'timer' => 3000,
