...
class Pangkalan extends Component
{
    use WithPagination;
    use LivewireAlert;
    use WithFileUploads;
    ...
    public function render()
    {
        ...
        return view('livewire.master.referensi.pangkalan.pangkalan', [
          'model'=> $rows
        ]);
    }
    ...
    //         ]);
    //     }
    //     return redirect()->route('master.referensi.pangkalan.pangkalang');
    ...
    public function deleteSelectedRequest($id)
    {
        if(Model::where('id',$id)->delete()){
            $log = 'Data Pangkalan Berhasil di Hapus';
            setActivity($log);
            $this->alert('success', $log, [
                'position' => 'top-end',
                'timer' => 3000,
            ...
            $log = 'Data Pangkalan Gagal di Hapus';
            $this->alert('error', $log, [
                'position' => 'top-end',
                'timer' => 3000,
                'toast' => true,
