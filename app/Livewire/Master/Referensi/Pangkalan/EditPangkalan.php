...
class EditPangkalan extends Component
{
    use LivewireAlert;
    ...
    {
        return view('livewire.master.referensi.pangkalan.edit-pangkalan');
    }
    ...
    public function mount($id)
    {
        ...
        $this->id_pangkalan         = $model->id;
        $this->id_agen   = $model->id_agen;
        $this->namapangkalan        = $model->namapangkalan;
    ...
    public function create()
    {
        $this->validate([
            ...
            $model = Model::where('id',$this->id_pangkalan)->first();
            $model->namapangkalan    = $this->namapangkalan;
            $model->notelp           = $this->notelp;
            $model->id_agen           = $this->id_agen;
            ...
            if($model->update()){
                $this->alert('success', 'Data Pangkalan Berhasil di Ubah', [
                    'position' => 'top',
                    'timer' => 3000,
                    'toast' => true,
                ...
                $this->alert('error', 'Data Pangkalan Gagal di Ubah', [
                    'position' => 'top',
                    'timer' => 3000,
                    'toast' => true,
                    'timerProgressBar' => true,
