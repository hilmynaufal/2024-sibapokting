...
class AddDistributor extends Component
{
    ...
    {
        return view('livewire.master.referensi.distributor.add-distributor');
    }
    ...
    public function create()
    {
        $this->validate([
            ...
            $model = Model::create([
                'namadistributor'     => $this->namadistributor,
                'notelp'          => $this->notelp,
            ...
            if($model->save()){
                $this->alert('success', 'Data Distributor Berhasil di Simpan', [
                    'position' => 'top',
                    'timer' => 3000,
                    'toast' => true,
                    'timerProgressBar' => true,
                ]);
                return redirect()->route('master.referensi.mapsdistributor', [Crypt::encrypt($model->id)]);
            }else{
                $this->alert('error', 'Data Distributor Gagal di Simpan', [
                    'position' => 'top',
                    'timer' => 3000,
                    'toast' => true,
                    'timerProgressBar' => true,
