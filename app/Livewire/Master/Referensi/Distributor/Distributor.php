...
class Distributor extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.master.referensi.distributor.distributor', [
          'model'=> $rows
        ]);
    }
    ...
    //         ]);
    //     }
    //     return redirect()->route('master.referensi.distributor.distributorg');
    ...
    public function deleteSelectedRequest($id)
    {
        if(Model::where('id',$id)->delete()){
            $log = 'Data Distributor Berhasil di Hapus';
            setActivity($log);
            $this->alert('success', $log, [
                'position' => 'top-end',
                'timer' => 3000,
            ...
            $log = 'Data Distributor Gagal di Hapus';
            $this->alert('error', $log, [
                'position' => 'top-end',
                'timer' => 3000,
                'toast' => true,
