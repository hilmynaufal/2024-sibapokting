...
class SuratMasukExport extends DefaultValueBinder implements FromQuery, WithHeadings, ShouldAutoSize, WithStyles, WithMapping, WithCustomValueBinder, WithTitle, WithEvents
{
    use Exportable;
    /**
